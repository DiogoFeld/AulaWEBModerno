...
function deleteAtribute(object, atribute) {
    if (Object.keys(object).includes(atribute)) {
        console.log(object.atribute)        
        delete object[atribute];//notação em string
        return object;
    }
}

const obj = { nome: "DI", idade: 12 }
console.log(deleteAtribute(obj, 'idade'))