// Lidar com números em JavaScript pode dar muita dor de cabeça. Você já viu o que acontece quando 
// faz seguinte comando no console: console.log(0.1 + 0.2); O resultado será: 0.30000000000000004.
...
function returnDinheiro(valor = 0.300000000004){
     valor = valor.toFixed(2);
     valor = "R$" + valor;
     valor = valor.replace(".",",")
     return valor;
}
console.log(returnDinheiro());
